...
function HeroSection() {
  ...
  return (
    <section className="relative isolate flex min-h-screen flex-col overflow-x-hidden bg-[#031226] pb-24 text-white sm:pb-36 lg:overflow-hidden lg:pb-44">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[92rem] flex-1 gap-0 px-4 sm:gap-10 sm:px-6 lg:min-h-screen lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:px-8 lg:pt-8 xl:gap-12">
        <div className="relative z-20 flex min-h-[100svh] flex-col justify-center py-20 lg:z-auto lg:min-h-0 lg:block lg:py-0 lg:pl-8 xl:pl-14">
        ...
        <div
          id="problem-map"
          className="relative z-10 mx-auto -mt-8 block h-[42rem] w-full max-w-none overflow-visible sm:mt-6 lg:z-auto lg:mt-0 lg:h-auto lg:max-w-[70rem] lg:-translate-y-6 lg:scale-125 xl:scale-[1.42]"
        >
